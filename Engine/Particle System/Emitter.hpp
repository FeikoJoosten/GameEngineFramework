...
/*
		...
		std::pair<float, float> GetBurstDuration();
		...
		/// </summary>
		/// <returns></returns>
		std::pair<float, float> GetBurstParticleCount();
		...
		std::pair<glm::vec3, glm::vec3> GetEmitterBox();
		...
		std::pair<glm::vec3, glm::vec3> GetEmitterLine();
